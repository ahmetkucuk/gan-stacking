...
small_n_mnist_samples = 100

layer0_model_epochs = 200
layer0_model_sample_size = 16*1000


layer1_model1_epochs = 200
layer1_model2_epochs = 200

layer1_model1_sample_size = 16*2500
layer1_model2_sample_size = 16*2500


layer2_model1_epochs = 400
layer2_model1_sample_size = 16*2500

mnist_trained_with_small_n_samples_epochs = 200
mnist_trained_with_gen_samples_epochs = 200
...
mnist_trained_with_small_n_samples = MnistConvModelTrain(MnistConvModel(), small_n_mnist_train_samples, mnist.test, name="SMALL NUMBER OF MNIST SAMPLES").train(mnist_trained_with_gen_samples_epochs)
mnist_trained_with_gen_samples = MnistConvModelTrain(MnistConvModel(), gen_mnist_train, mnist.test, name="MNIST WITH GENERATED SAMPLES").train(mnist_trained_with_gen_samples_epochs)
